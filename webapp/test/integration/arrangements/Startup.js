sap.ui.define([
	"sap/ui/test/Opa5",
	"com/opensap/ManageProducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.opensap.ManageProducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.opensap.ManageProducts",
					async: true
				},
				hash: oOptions.hash,
