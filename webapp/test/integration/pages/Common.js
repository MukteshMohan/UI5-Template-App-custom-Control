sap.ui.define([
	...
	return Opa5.extend("com.opensap.ManageProducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/opensap/ManageProducts/localService/mockserver"], function (mockserver) {
